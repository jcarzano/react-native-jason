...
import UpcomingSubsriptionCard from "@/components/UpcomingSubsriptionCard";
  ...
  return (
    <SafeAreaView className="flex-1 p-5">
      ...
      <View className="my-2 min-h-50 justify-between gap-5 rounded-bl-4xl rounded-tr-4xl bg-accent p-5">
        <Text className="text-xl font-sans-semibold text-white/100">
          Balance
        </Text>
        <View className="flex-row items-center justify-between">
          <Text className="text-3xl font-sans-extrabold text-white">
            {formatCurrency(523489.48)}
          </Text>
          <Text className="text-xl font-sans-medium text-white">
            {dayjs("2026-08-18T09:00:00.000Z").format("MM/DD")}
          </Text>
        </View>
      </View>
      ...
      <View>
        ...
        <UpcomingSubsriptionCard data={UPCOMING_SUBSCRIPTIONS[0]} />
      </View>
